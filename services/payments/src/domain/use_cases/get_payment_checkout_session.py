...
class GetPaymentCheckoutSessionUseCase(BaseUseCase[str, PaymentCheckoutStatusResponse]):
    def __init__(self, repository: PaymentCheckoutRepository):
        self.repository = repository

    def execute(self, payment_transaction_id) -> PaymentCheckoutStatusResponse:
